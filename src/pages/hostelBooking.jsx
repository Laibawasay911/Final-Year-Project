  ...
  return (
    <div className="container mx-auto px-6 py-20">
      ...
      <form onSubmit={handleSubmit} className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow space-y-6">
        ...
        <input type="text" name="university" onChange={handleChange} placeholder="University Name" className="w-full p-3 border rounded" required />
        <input type="date" name="checkIn" onChange={handleChange} className="w-full p-3 border rounded" required />
        <input type="date" name="checkOut" onChange={handleChange} className="w-full p-3 border rounded" required />
        <input type="number" name="guests" min="1" onChange={handleChange} value={formData.guests} className="w-full p-3 border rounded" required />
